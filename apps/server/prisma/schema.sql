...
ALTER TABLE "Backup" DROP CONSTRAINT IF EXISTS "Backup_userId_fkey";
...
ALTER TABLE "WeeklyPlan" DROP CONSTRAINT IF EXISTS "WeeklyPlan_userId_fkey";
...
ALTER TABLE "TimeBlock" DROP CONSTRAINT IF EXISTS "TimeBlock_planId_fkey";
ALTER TABLE "TimeBlock" ADD CONSTRAINT "TimeBlock_planId_fkey" FOREIGN KEY ("planId") REFERENCES "WeeklyPlan"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "TimelineEvent" DROP CONSTRAINT IF EXISTS "TimelineEvent_dailyLogId_fkey";
ALTER TABLE "TimelineEvent" ADD CONSTRAINT "TimelineEvent_dailyLogId_fkey" FOREIGN KEY ("dailyLogId") REFERENCES "DailyLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "TimelineEvent" DROP CONSTRAINT IF EXISTS "TimelineEvent_userId_fkey";
...
ALTER TABLE "Meal" DROP CONSTRAINT IF EXISTS "Meal_dailyLogId_fkey";
...
ALTER TABLE "Attachment" DROP CONSTRAINT IF EXISTS "Attachment_dailyLogId_fkey";
...
ALTER TABLE "HabitLog" DROP CONSTRAINT IF EXISTS "HabitLog_userId_fkey";
...
ALTER TABLE "Milestone" DROP CONSTRAINT IF EXISTS "Milestone_goalId_fkey";
...
ALTER TABLE "Project" DROP CONSTRAINT IF EXISTS "Project_goalId_fkey";
